...
# 🆕 升級 v1.9.0：新增 Tab 2 雲端多圖知識庫管理，Tab 1 完美對接 GitHub 實時讀寫與 GPT-4o 雙階分析
...
def upload_knowledge_base_to_github(name, b64_images):
    """將多張圖片的 base64 打包存入 GitHub repository"""
